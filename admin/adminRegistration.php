...
// Check connection
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $sql = "INSERT INTO admin (Uname,adminName,address,NIC,telNo,email,password) VALUES ('$userName','$firstName . $lastName ',' $addressLine1 . $addressLine2 . $city ','$NIC','$telNo','$email','$password');";
